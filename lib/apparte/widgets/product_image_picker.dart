// lib/shared/widgets/product_image_picker.dart
...
class ProductImagePicker extends StatefulWidget {
  final String? initialImagePath;  // Caminho relativo ou URL completa
...
class _ProductImagePickerState extends State<ProductImagePicker> {
  ...
  void initState() {
    super.initState();
    // 🔥 Converte URL completa para caminho relativo se necessário
    _imagePath = ImageHelper.extractPath(widget.initialImagePath) ?? widget.initialImagePath;
  }

  @override
  Widget build(BuildContext context) {
    // 🔥 Converte caminho relativo para URL completa para exibição
    final imageUrl = ImageHelper.getFullImageUrl(_imagePath);
