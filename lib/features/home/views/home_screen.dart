...
import '../../loja/views/criar_loja_screen.dart';
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            final result = await Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const CriarLojaScreen()),
            );
            if (result == true && mounted) {
              // ignore: use_build_context_synchronously
              context.read<LojaCubit>().fetchLojas();
            }
          },
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.push(context, MaterialPageRoute(builder: (_) => const CriarLojaScreen()));
            },
          ),
          ListTile(
