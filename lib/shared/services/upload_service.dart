// lib/shared/services/upload_service.dart
...
class UploadService {
  ...
  // 🔥 USAR AppConstants para as pastas
  ...
  /// 🔥 Remove a imagem usando o caminho relativo
  Future<void> deleteImage(String path) async {
    try {
      // 🔥 Usa ImageHelper para extrair o caminho
...
/// 🔥 Resultado do upload
class UploadResult {
  final String path;    // Caminho relativo: "uploads/produtos/loja_22/2026/09/arquivo.jpg"
  final String url;     // URL relativa: "/uploads/produtos/loja_22/2026/09/arquivo.jpg"
...
/// 🔥 Exceção customizada para upload
