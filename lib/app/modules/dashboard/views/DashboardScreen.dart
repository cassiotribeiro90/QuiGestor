          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                RepaintBoundary(child: DashboardKpis(kpis: dados['kpis'] ?? {})),
                const SizedBox(height: 24),
              ...
              if (isMobile)
                ...List.generate(
                  ...
                  (_) => Padding(
                    ...
                    child: _skeletonKpiCard(baseColor, highlightColor),
                  ),
                )
              else ...[
                Row(
                  children: [
                    Expanded(child: _skeletonKpiCard(baseColor, highlightColor)),
